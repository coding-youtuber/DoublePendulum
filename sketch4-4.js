...
function draw() {
  ...
  if(frameCount > 1) {
    ...
    // buffer.stroke('rgba(0,255,0, 0.55)');
    // buffer.stroke('rgb(0,255,0)');
    buffer.stroke(0, (255 - A) + A * cos(frameCount / 10), (255 - B) + B * sin(frameCount / 10));
    // buffer.stroke('rgba(' + abs(sin(frameCount)) + ',255,0, 0.55)');
